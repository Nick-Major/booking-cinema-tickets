    ...
    <div class="popup__content">
      <div class="popup__header">
        <h2 class="popup__title">
          Удаление фильма
          <a class="popup__dismiss" href="#" onclick="closeDeleteMovieModal(event)"><img src="{{ asset('images/admin/close.png') }}" alt="Закрыть"></a>
        </h2>
      </div>
      <div class="popup__wrapper">
        <form id="deleteMovieForm" onsubmit="confirmMovieDeletion(event)">
          ...
          <div class="conf-step__buttons text-center">
            ...
            <button type="button" class="conf-step__button conf-step__button-regular" onclick="closeDeleteMovieModal(event)">Отменить</button>
          </div>
        </form>
      </div>
    </div>
